  ...
  return {
    ...
    ...(params.gatewayRequestContext
      ? {
          ...
          // Preserve the gateway-owned resolver rather than closing over a context. The resolver
          // is the lifecycle fence: it becomes unavailable when this Gateway retires.
