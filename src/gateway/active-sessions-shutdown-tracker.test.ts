...
// The tracker intentionally uses a process-global singleton, so another test file
// in the same Vitest worker can leave a live session behind before this file starts.
