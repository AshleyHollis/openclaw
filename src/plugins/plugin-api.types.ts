...
export type OpenClawPluginApi = {
  ...
  registerGatewayMethod: (
    ...
    opts?: {
      ...
      /**
       * Exact core Gateway methods this handler may dispatch while its
       * authenticated caller remains current. Requires the manifest's
       * `gatewayMethodDispatch: ["authenticated-request"]` contract.
       */
