...
after the stale-run window (2 hours, or the configured run timeout plus a short
grace period, whichever is longer). These retained counts govern `/subagents list`,
